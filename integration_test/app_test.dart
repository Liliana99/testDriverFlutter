...
import 'package:flutter_integration_test_driver/main.dart';
import 'package:flutter_test/flutter_test.dart';
import 'package:integration_test/integration_test.dart';

void main() {
//*Antes de nada escribir esta linea, inicializar
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final inputText = 'Hello there, this is an input for the test.';
